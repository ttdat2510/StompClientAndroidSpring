...
import com.example.stompclientandroidspring.R;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mStompClient = Stomp.over(Stomp.ConnectionProvider.OKHTTP, "ws://5cdecd96.ngrok.io/ws/websocket");
  ...
  public void connectStomp(View view) {
    ...
    // Receive greetings
    Disposable dispTopic = mStompClient.topic("/notification/VID1001")
        .subscribeOn(Schedulers.io())
        .observeOn(AndroidSchedulers.mainThread())
